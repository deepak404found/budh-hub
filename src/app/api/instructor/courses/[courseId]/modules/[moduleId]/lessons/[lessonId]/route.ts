...
export async function GET(
  ...
  try {
    ...
    // Validate UUIDs
    if (!isValidUUID(courseId) || !isValidUUID(moduleId) || !isValidUUID(lessonId)) {
  ...
  try {
    ...
    const [updatedLesson] = await db
      ...
      .set({
        ...
        ...(validatedData.video_key !== undefined && { video_key: validatedData.video_key || null }),
        ...(validatedData.video_size !== undefined && { video_size: validatedData.video_size || null }),
        ...(validatedData.video_duration !== undefined && { video_duration: validatedData.video_duration || null }),
        ...(validatedData.video_mime_type !== undefined && { video_mime_type: validatedData.video_mime_type || null }),
...
export async function DELETE(
  ...
  try {
    ...
    // TODO: Delete video from R2 if video_key exists
