 ...
 */
export function generatePasswordResetTemplate(url: string, host: string, email: string): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Reset your password - BudhHub</title>
</head>
<body style="margin: 0; padding: 0; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f4f4f5;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
    <!-- Header -->
    ...
    <tr>
      <td style="padding: 32px 24px;">
        ...
        <!-- Security Notice -->
        <div style="margin-top: 32px; padding: 16px; background-color: #fee2e2; border-radius: 6px; border-left: 4px solid #ef4444;">
          <p style="margin: 0; font-size: 14px; line-height: 20px; color: #991b1b;">
            <strong>🔒 Security Notice:</strong><br>
            If you didn't request a password reset, you can safely ignore this email.
            Your password will remain unchanged. This link will only work once and expires in 1 hour.
          </p>
        </div>
      </td>
    </tr>
